...
participants_resign = [
    '11-DNA', # Administração
    '22-GLB', # Arquitetura
    '26-IGR', # Química
    '31-JUA', # Engenharia
    '33-VCT', # Matemática
    '42-MGH', # Português de Cabo Verde
    '48-ALA'  # Ciências da computação
]

participants_human_error = [
    '16-GUA', # Ciências da computação
    '41-JLM', # Matemática
    '45-MCR', # Ciências da computação
]

participants_foreign_languages = [
    '17-XIL', # Matemática, Espanhol da Guatemala
    '25-NIC', # Engenharia de materiais, Espanhol da Colômbia
    '30-CRL', # Matemática, Espanhol do Perú
    '35-SMI', # Engenheria ambiental, Libanês (fala cinco idiomas)
]

participants_to_ignore = participants_foreign_languages + participants_resign + participants_human_error
